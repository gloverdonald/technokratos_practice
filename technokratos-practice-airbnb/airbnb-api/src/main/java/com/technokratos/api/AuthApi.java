...
public interface AuthApi {
    ...
    UUID create(@ApiParam(value = "Данные для регистрации") @Valid @RequestBody RegistrationRequest userRequest);
    ...
    TokensResponse login(@ApiParam(value = "Логин и пароль") @Valid @RequestBody LoginRequest userRequest);
